...
void program_context_put_boolean(ProgramContext *self, const char *key,
                                 BOOL value);
void program_context_put_integer(ProgramContext *self, const char *key,
                                 int value);
void program_context_put_int64(ProgramContext *self, const char *key,
                               int64_t value);
BOOL program_context_get_boolean(const ProgramContext *self, const char *key,
                                 BOOL deflt);
int program_context_get_integer(const ProgramContext *self, const char *key,
                                int deflt);
int64_t program_context_get_int64(const ProgramContext *self, const char *key,
                                  int64_t deflt);
BOOL program_context_parse_command_line(ProgramContext *self, int argc,
                                        char **argv);
...
void program_context_setup_logging(ProgramContext *self,
                                   LogHandler log_handler);
void program_context_printf(const ProgramContext *self, int flags,
                            const char *fmt, ...);
