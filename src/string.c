...
*==========================================================================*/
String *string_substitute_all(const String *self, const char *search,
                              const char *replace) {
...
*==========================================================================*/
BOOL string_create_from_utf8_file(const char *filename, String **result,
                                  char **error) {
  String *self = NULL;
  BOOL ok = FALSE;
  ...
  if (f > 0) {
    ...
    *result = self;
    ...
    asprintf(error, "Can't open file '%s' for reading: %s", filename,
             strerror(errno));
    ok = FALSE;
  }
