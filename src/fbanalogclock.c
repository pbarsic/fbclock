...
==========================================================================*/
static void draw_hand(Region *r, double angle, int cx, int cy, int thickness,
                      int l, BYTE cr, BYTE cg, BYTE cb) {
  int lx = l * sin(angle);
  int ly = l * cos(angle);
...
==========================================================================*/
static void draw_date(Region *r, int l, int cx, int cy, BYTE cr, BYTE cg,
                      BYTE cb, const BitmapFont *font) {
  ...
  region_draw_bitmap_text(r, font, s, cx - xo, cy - 2 * text_height, cr, cg,
                          cb);
}
...
==========================================================================*/
static void draw_numerals(Region *r, int l, int cx, int cy, BYTE cr, BYTE cg,
                          BYTE cb, const BitmapFont *font) {
  int text_height = font->height;
  int text_width = font->width;
  for (int i = 0; i < 12; i++) {
